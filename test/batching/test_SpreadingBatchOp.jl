@testitem "SpreadingBatchOp" tags = [:batching, :SpreadingBatchOp] setup=[TestUtils] begin
    using Random, BenchmarkTools, AbstractOperators, JLArrays
    Random.seed!(0)
...
function test_failing_nonthreadsafe_spreading_batch_op()
    ...
    return @test_throws ArgumentError BatchOp(ops, n, (:b, :s, :_) => (:b, :s, :_, :_); threaded = true, threading_strategy = ThreadingStrategy.FIXED_OPERATOR)
end
