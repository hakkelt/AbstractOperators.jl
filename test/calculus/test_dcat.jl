@testitem "DCAT: basic mul" tags = [:calculus, :DCAT] setup = [TestUtils] begin
    ...
    A1 = randn(m1, n1); A2 = randn(m2, n2); A3 = randn(m3, n3)
...
@testitem "DCAT: properties" tags = [:calculus, :DCAT] setup = [TestUtils] begin
    ...
    m1, n1, m2, n2 = 4, 7, 5, 2
    A1 = MatrixOp(randn(m1, n1)); A2 = MatrixOp(randn(m2, n2))
    op = DCAT(A1, A2)
...
@testitem "DCAT: displacement" tags = [:calculus, :DCAT] setup = [TestUtils] begin
    ...
    m1, n1, m2, n2, m3, n3 = 4, 7, 5, 2, 5, 5
    A1 = randn(m1, n1); A2 = randn(m2, n2); A3 = randn(m3, n3)
    d1 = randn(m1); d2 = randn(m2); d3 = randn(m3)
    opD = DCAT(AffineAdd(MatrixOp(A1), d1), AffineAdd(MatrixOp(A2), d2), AffineAdd(MatrixOp(A3), d3))
    x1 = randn(n1); x2 = randn(n2); x3 = randn(n3)
