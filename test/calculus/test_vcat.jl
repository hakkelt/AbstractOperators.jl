@testitem "VCAT: basic mul" tags = [:calculus, :VCAT] setup = [TestUtils] begin
    ...
    m1, m2, m3, n = 4, 7, 3, 5
    A1 = randn(m1, n); A2 = randn(m2, n); A3 = randn(m3, n)
...
@testitem "VCAT: properties" tags = [:calculus, :VCAT] setup = [TestUtils] begin
    ...
    m1, m2, n = 4, 7, 5
    A1 = MatrixOp(randn(m1, n)); A2 = MatrixOp(randn(m2, n))
    op3 = VCAT(A1, A2)
...
@testitem "VCAT: displacement" tags = [:calculus, :VCAT] setup = [TestUtils] begin
    ...
    A1b = MatrixOp(randn(m1, n)); A2b = MatrixOp(randn(m2, n))
    op = VCAT(A1b, A2b)
...
@testitem "VCAT: slicing utilities" tags = [:calculus, :VCAT] setup = [TestUtils] begin
    ...
    A1 = Eye(3); A2 = Eye(3); A3 = Eye(3)
    V2 = VCAT(A1, A2); V3 = VCAT(A1, A2, A3)
    ...
    Aeq1 = MatrixOp(randn(3, 4)); Aeq2 = MatrixOp(randn(5, 4))
